...
const TablaReportePresionEncuestaPresion = ( 
    { mostrarReporte, actividadPresiones, zonas, tiposAltitud, zonaReporte, altitudReporte, tipoReporte } ) => {
        
    if(mostrarReporte && tipoReporte === "1"){ 
        return (
                                            ...
                                            if(cantidadRegistrosZonaAltitud > 0){
                                                return(
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td colSpan={5} style={{border:'1px solid black', textAlign:'center'}}>&nbsp;{((promedioPresionAltitud/cantidadPresionAltitud)||0).toFixed(2)}&nbsp;</td>
                                                    </tr>
                                                    </React.Fragment>
                                                )
                                            }else { return null} 
...
export default TablaReportePresionEncuestaPresion
