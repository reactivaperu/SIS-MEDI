...
const TablaReporteResumenContinuidad = ( 
    { mostrarReporte, promedioPonderados, zonas, zonaReporte, tipoReporte } ) => {
        
    if(mostrarReporte && tipoReporte === "4"){
        ...
        <div id="reporteResumenContinuidad">
            ...
            <thead>
                    <tr>
                        <th colSpan={5} style={{border:'1px solid black',textAlign:'center'}}>&nbsp;CONTINUIDAD SEGÚN PROCESO OPRATIVO&nbsp;</th>
                    </tr>
                    <tr>
                ...
                { 
                    ...
                    .map(zona => {
                        ...
                        promedioPonderados.forEach(promedio => {
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td style={{border:'1px solid black', textAlign:'center'}}>{ (promedioGeneralHora||0).toFixed(2) } &nbsp; (Horas)</td>
                    </tr>
                    <tr>
                        <td style={{border:'1px solid black', textAlign:'center'}}>PROMEDIO GENERAL</td>
                        <td style={{border:'1px solid black', textAlign:'center'}}>{ convertirNumeroAHora((promedioGeneralHora||0),"hh:mm:ss")} &nbsp; (Hr:Min:Seg)</td>
                    </tr>
                </tbody>
            </table>
            </div>
